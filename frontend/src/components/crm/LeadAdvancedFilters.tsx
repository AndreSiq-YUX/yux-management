...
export function LeadAdvancedFilters({ filters, stages, sources, onChange }: LeadAdvancedFiltersProps) {
  return (
    <section className="grid gap-3 rounded-lg border bg-white p-3 md:grid-cols-5">
      <Input
