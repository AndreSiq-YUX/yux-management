...
export function MissionExecutionTimeline({ actions, canWrite, busyActionId, dailyQueueHref, onRetry, onResolveHuman }: {
  actions: MissionActionRun[]; canWrite: boolean; busyActionId?: string; dailyQueueHref?: string; onRetry: (action: MissionActionRun) => void; onResolveHuman: (action: MissionActionRun) => void
}) {
  return (
