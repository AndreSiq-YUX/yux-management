...
import { Archive, CheckCircle2, ExternalLink, FileText, Loader2, Settings2 } from 'lucide-react'
...
import type { CompanyKnowledgeDocument, CompanyKnowledgeVisibility } from '@/types/companyIntelligence'
        ...
        {filtered.map(document => (
          <article key={document.id} className="rounded-lg border bg-white p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {document.status === 'indexed' && <Action label="Publicar" icon={CheckCircle2} onClick={async () => onChanged(await companyIntelligenceService.publishKnowledge(document.id))} />}
