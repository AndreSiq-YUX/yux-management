        ...
        *,
        ...
        if plan["workflow_key"] == "mission_intake_conversation":
            ...
            contract = (
                ...
                "knownFacts:[{key:'identificador',value:'informação confirmada',sourceRef:'ref exata do catálogo'}],"
                ...
                "Informações sem fonte verificável devem ficar em assumptions, com key e value, sem sourceRef. "
                "Em assumptions sourceRef é opcional; quando presente, também exige uma ref real do catálogo. "
