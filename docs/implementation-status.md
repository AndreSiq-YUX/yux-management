...
| Marketing Studio Radar and research | Implemented | `/marketing-studio` | `20260607003007_marketing_studio_radar_research.sql`, `2026-06-07-yux-marketing-studio-radar-research.md`, worker Jina Reader/Search request builders, source item/radar service methods, internal Radar panel | Adds controlled source items, research cache, Radar runs, dedupe keys, opportunity scores and typed conversion from captured source item to idea. Migration and probe passed remotely. Live scheduled jobs and provider credentials remain follow-up operational work. |
