...
export type DomainEventAggregateType = 'lead' | 'form_submission' | 'task' | 'sequence_enrollment' | 'sequence_execution' | 'email' | 'campaign' | 'mission' | 'mission_action' | 'action_run' | 'approval' | 'channel_webhook_event' | 'strategy_pack' | 'knowledge_document'
