...
export type DomainEventAggregateType = 'lead' | 'form_submission' | 'task' | 'sequence_enrollment' | 'email' | 'campaign' | 'mission' | 'mission_action' | 'action_run' | 'approval' | 'channel_webhook_event'
